...
onMounted(async () => {
  ...
  const planets = [
    ...
    new Planet(
      ...
      0xaaaaaa,
      [0.39, 0, 0],
      [0, 0, calculateOrbitalVelocityAUPerDay(0.39)]
    ),
    new Planet(
      "Venus",
      4.87,
      ...
      0xe39e1c,
      [0.72, 0, 0],
      [0, 0, calculateOrbitalVelocityAUPerDay(0.72)]
    ),
    new Planet(
      "Earth (399)",
      5.97,
      ...
      0x2233dd,
      [1.0, 0, 0],
      [0, 0, calculateOrbitalVelocityAUPerDay(1.0)]
    ),
    new Planet(
      "Mars",
      0.642,
      ...
      0xdd3333,
      [1.52, 0, 0],
      [0, 0, calculateOrbitalVelocityAUPerDay(1.52)]
    )
...
<template>
  ...
  <button class="enable-button" @click="togglePrediction">
    {{ enablePrediction ? "Disable" : "Enable" }} Prediction
  </button>
</template>
